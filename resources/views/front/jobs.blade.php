        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <div class="card border-0 shadow p-4">
                    <div class="mb-4">
                        <h2>Keywords</h2>
                        <input type="text" value="{{ Request::get('keyword') }}" id="keyword" name="keyword" placeholder="Keywords" class="form-control">
                    </div>

                    <div class="mb-4">
                        <h2>Location</h2>
                        <input type="text" value="{{ Request::get('location') }}" id="location" name="location" placeholder="Location" class="form-control">
                    </div>
                                ...
                                @if ($jobs->isNotEmpty())
                                    ...
                                    @else
                                       <div class="col-md-12 text-center">
                                         <div style="font-size: 24px; font-weight: 1200; margin-top: 200px;">Jobs not found.</div>
                                       </div>
                                @endif
                    </div>
                    </div>
