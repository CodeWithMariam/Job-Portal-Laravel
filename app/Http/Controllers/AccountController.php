...
class AccountController extends Controller
{
    ...
    public function updateProfilePic(Request $request)
    {
        ...
        if( $validator->passes()){
            ...
            // crop the best fitting  (150x150) ratio and resize to  pixel
            $image->cover(150, 150);
   ...
   public function removeJobs(Request $request){
    $jobApplications = JobApplications::where([
                    'id' => $request->id,
                    'user_id' => Auth::user()->id
            ])->first();
        ...
        JobApplications::find($request->id)->delete();
   ...
   public function showSavedJobs(Request $request){
   ...
   public function resetPassword($tokenString){
    ...
    $token = DB::table('password_reset_tokens')->where('token', $tokenString)->first();
      ...
      if( $token == null ){
        return redirect()->route('account.forgetPassword')->with('error', 'Invalid or expired token.');
   ...
   public function processResetPassword(Request $request){
    ...
    $validator = Validator::make($request->all(), [
      ...
      return redirect()->route('account.login')->with( 'success','You have successfully changed your password password.');
