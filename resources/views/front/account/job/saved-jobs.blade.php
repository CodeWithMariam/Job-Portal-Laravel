            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#" class="cls">Home</a></li>
                                    ...
                                    @else
                                     <tr>
                                        <td colspan="5" class="text-center">
                                            <div style="font-size: 24px; font-weight: 900; margin-top: 20px;">Job not found.</div>
                                        </td>
                                     </tr>
                                   @endif
                                </tbody>
        ...
        if(confirm('Are you sure you want to remove?')){
            $.ajax({
                ...
                success: function(response){
                    window.location.href='{{ route("account.showSavedJobs") }}'
                }
             });
