            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('jobs') }}" class="cls"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Jobs</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                       ...
                       <table class="table table-striped">
                            ...
                            @if ($applications->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td>{{ $application->user->mobille }}</td>
                                ...
                                <tr>
                                  <td colspan="4" class="text-center">
                                      <div style="font-size: 20px; font-weight: 900; margin-top: 20px;">Applicants not found.</div>
                                  </td>
                                </tr>
                            @endif
                       </table>
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                <li>Webite: <span><a class="cls" href="{{ $job->company_website }}">{{ $job->company_website }}</a></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
